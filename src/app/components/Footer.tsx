      ...
      <div className="container mx-auto px-6" style={{ maxWidth: 1200 }}>
        ...
        >
          ...
          <div style={{ flex: 1.5 }}>
            ...
            >
              Công ty Cổ phần Công Nghệ GOG Việt Nam - đơn vị hàng đầu trong
              lĩnh vực tuyển dụng và phát triển nhân lực chất lượng cao.
            </p>
              ...
              {[
                {
                  ...
                  text: "Số 45, đường An Dương Vương, Phường Trường Thi, TP Vinh, Nghệ An.",
                },
                {
                  icon: (
                    <svg
                ...
                >
                  <div
                    style={{ color: "#f5a623", marginTop: 2, flexShrink: 0 }}
                  >
                    {item.icon}
                  </div>
                  <span
        ...
        >
          <span>
            © {currentYear} GO GROUP - Công Ty Cổ Phần Công Nghệ GOG Việt Nam.
            Bảo lưu mọi quyền.
          </span>
